...
files = {
    'wdn_reports/Twoloops_SP_672_HTS_5_Noise_2.txt',
    'run_010_leaks/wntr_sp_672_dt_5_Nu_2_leak_0.mat',
    'run_010_leaks/wntr_sp_672_dt_5_Nu_2_leak_1.mat',
    'run_010_leaks/wntr_sp_672_dt_5_Nu_2_leak_2.mat',
    'run_010_leaks/wntr_sp_672_dt_5_Nu_2_leak_3.mat',
    'run_010_leaks/wntr_sp_672_dt_5_Nu_2_leak_4.mat',
    'run_010_leaks/wntr_sp_672_dt_5_Nu_2_leak_5.mat',
    'run_010_leaks/wntr_sp_672_dt_5_Nu_2_leak_6.mat',
    'run_010_leaks/wntr_sp_672_dt_5_Nu_2_leak_7.mat',
    'run_010_leaks/wntr_sp_672_dt_5_Nu_2_leak_8.mat',
    };
...
[resout, TT, node_ids, link_ids] = read_EPANET_rpt(cell2mat(files(1)),SP,5);
H = resout(1:end,8:14);
H = H';
...
%    T = TT';
    ...
    Hx_cv = H_cv(1:length(H_names),:);
    Hx_cv = Hx_cv(:,1:end-1);   
    dHx_cv = H_cv(1:length(H_names),:);
    dHx_cv = dHx_cv(:,2:end);

    Dx_cv = D_cv(1:length(D_names),:);
    Dx_cv = Dx_cv(:,1:end-1);  
    dDx_cv = D_cv(1:length(D_names),:);
    dDx_cv = dDx_cv(:,2:end);
    
    Qpx_cv = Qp_cv(1:length(Qp_names),:);
    Qpx_cv = Qpx_cv(:,1:end-1);
    dQpx_cv = Qp_cv(1:length(Qp_names),:);
