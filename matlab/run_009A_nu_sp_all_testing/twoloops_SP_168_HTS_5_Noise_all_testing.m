...
files = {
    ...
    'wdn_reports/Twoloops_SP_168_HTS_5_Noise_4.txt',
    'wdn_reports/Twoloops_SP_168_HTS_5_Noise_6.txt',
    'wdn_reports/Twoloops_SP_168_HTS_5_Noise_8.txt',
    'wdn_reports/Twoloops_SP_168_HTS_5_Noise_10.txt'
    };
...
for i=2:length(files)
    ...
    [resout, TT, node_ids, link_ids] = read_EPANET_rpt(cell2mat(files(i)),SP,5);
    H_cv = resout(1:end,8:14);
    H_cv = H_cv';
    D_cv = resout(1:end,1:6)/3.6; 
    D_cv = D_cv';
    Qp_cv = resout(1:end,22:29)/3.6;
    Qp_cv = Qp_cv';
    T = TT';
